...
**Removing a service**: To decommission a service, follow docs/playbooks/REMOVE_SERVICE.md.

**Configuring a service**: To configure a service whose value lives in a hand-authored config file (secrets, external APIs, or destructive actions), follow docs/playbooks/CONFIGURE_SERVICE.md.
